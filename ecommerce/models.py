...
class Setting(models.Model):
    ...
    bannerbottom1=models.ImageField(default="banner/ab_pic.jpg")
    bannerbottom2=models.ImageField(default="banner/ab_pic.jpg")
    schedulebottom=models.ImageField()
    trending1=models.ImageField()
    trending2=models.ImageField()
    trending3=models.ImageField()
    bannerlast1=models.ImageField()
    bannerlast2=models.ImageField()
    contactbanner=models.ImageField(default="banner/ab_pic.jpg")
